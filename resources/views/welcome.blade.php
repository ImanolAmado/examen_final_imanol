    ...
    <div class="container mx-auto p-6 grid grid-cols-1 md:grid-cols-1 gap-6">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <p class="text-gray-700">
                Disponemos de una base de <i>(<b>RELLENAR</b> con la cantidad de peliculas)</i> peliculas.
            </p>
            <p class="text-gray-700">
                Dispruta de nuestra lista de <i>(<b>RELLENAR</b> de actores y actrices)</i> actores.
            </p>
        </div>
    </div>
@endsection